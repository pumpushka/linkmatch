$( document ).ready(function() {
    ...
    els.partner_form.submit(
        function (event) {
            preventDefault();
            apostle.domainKey = "3b859aa28caae8821bea39b029ff3be32977d88b";
            apostle.deliver(
                'person_name : ' + els.person.val()+
                'company_name : ' + els.company.val()+
                'email : ' + els.email.val()+
                'message : ' + els.message.val()
            , {email: "team@linkmatch.net"});
        }
    );
